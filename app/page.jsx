      ...
      <section id="about" className="h-full py-12 xl:py-24">
        <div className="container h-full mx-auto">
          <div className="flex items-center justify-center px-10">
            ...
            >
              <h1 className="mb-8 text-4xl font-bold xl:text-6xl">
                <span style={{ color: 'var(--foreground)' }}>About </span>
                <span style={{ color: 'var(--accent)' }}>Me</span>
              </h1>

              <h2 className="mb-10 text-xl font-semibold xl:text-2xl" style={{ color: 'var(--foreground)' }}>
                Passionate Developer & Problem Solver
              </h2>

              <div className="space-y-6">
                <p className="leading-relaxed text-base xl:text-lg" style={{ color: 'var(--foreground)', opacity: 0.9 }}>
